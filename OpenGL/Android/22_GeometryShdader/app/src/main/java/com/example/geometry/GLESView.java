...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer ,OnDoubleTapListener,OnGestureListener
{
		  ...
		  if(iShaderCompileStatus[0] == GLES32.GL_FALSE)
		  {
		        GLES32.glGetShaderiv(geometryShaderObject,
                        ...
                        if(iInfoLogLength[0] > 0)
                        {
                                ...
                                System.out.println("RTR: geometry shader ERROR: " + szInfoLog);
                                //uninitialize();
                                System.exit(0);
                        }
	...
	private void display()
	{
		...
		Matrix.translateM(modelViewMatrix, 0 ,translateMatrix, 0, 0.0f, 0.0f, -4.5f);
	 ...
	 //draw neccessaary matrices
	         GLES32.glDrawArrays(GLES32.GL_TRIANGLES,    //what to draw from given array
