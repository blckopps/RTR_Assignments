...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer ,OnDoubleTapListener,OnGestureListener
{
	...
	final float[] smiley_texcoord = new float[8];
	...
	private void display()
	{
		...
		if(choice == 1)
		{
		     smiley_texcoord[0] = 1.0f;
		     smiley_texcoord[1] = 1.0f;
		        
		     smiley_texcoord[2] = 0.0f;   
		     smiley_texcoord[3] = 1.0f;   
		     
		     smiley_texcoord[4] = 0.0f;   
		     smiley_texcoord[5] = 0.0f;   
		     
		     smiley_texcoord[6] = 1.0f;
		     smiley_texcoord[7] = 0.0f;         
		}
		else if(choice == 2)
		{
		     smiley_texcoord[0] = 0.5f;
		     smiley_texcoord[1] = 0.5f;
		        
		     smiley_texcoord[2] = 0.0f;   
		     smiley_texcoord[3] = 0.5f;   
		     
		     smiley_texcoord[4] = 0.0f;   
		     smiley_texcoord[5] = 0.0f;   
		     
		     smiley_texcoord[6] = 0.5f;
		     smiley_texcoord[7] = 0.0f;  
		}
		else if(choice == 3)
		{
		  smiley_texcoord[0] = 2.0f;
		  smiley_texcoord[1] = 2.0f;
		  smiley_texcoord[2] = 0.0f;
		  smiley_texcoord[3] = 2.0f;
		  smiley_texcoord[4] = 0.0f;
		  smiley_texcoord[5] = 0.0f;
		  smiley_texcoord[6] = 2.0f;
		  smiley_texcoord[7] = 0.0f; 
		}
		
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER, vbo_texcoord[0]);
		
		ByteBuffer byteBufferTex = ByteBuffer.allocateDirect(smiley_texcoord.length * 4);
		 ...
		 textureBuffer.put(smiley_texcoord);

		 textureBuffer.position(0);
		 
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,
				    smiley_texcoord.length * 4,
				    textureBuffer,
				    GLES31.GL_STATIC_DRAW);
		...
		Matrix.translateM(modelViewMatrix, 0 ,translateMatrix, 0, 0.0f, 0.0f, -4.0f);
