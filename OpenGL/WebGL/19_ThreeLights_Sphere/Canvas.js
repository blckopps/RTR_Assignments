...
var laUniform_PV_RED,ldUniform_PV_RED, lsUniform_PV_RED;
var laUniform_PV_GREEN,ldUniform_PV_GREEN, lsUniform_PV_GREEN;
var laUniform_PV_BLUE,ldUniform_PV_BLUE, lsUniform_PV_BLUE;

var kaUniform,kdUniform_PV, ksUniform_PV;

var shininessUniform_PV;
var lightPositionUniform_PV_RED, lightPositionUniform_PV_GREEN, lightPositionUniform_PV_BLUE;
...
//Red
var lightDifuse_RED = [ 1.0, 0.0, 0.0];
var lightSpecular_RED = [ 1.0, 0.0, 0.0 ];
//Green
var lightDifuse_GREEN = [ 0.0, 1.0, 0.0];
var lightSpecular_GREEN = [ 0.0, 1.0, 0.0 ];
//Blue
var lightDifuse_BLUE = [ 0.0, 0.0, 1.0];
...
var lightPosition_RED = [ 0.0, angle_light, angle_light, 1.0];
var lightPosition_GREEN = [ angle_light, 100.0, angle_light, 1.0];
var lightPosition_BLUE = [ angle_light, angle_light, 100.0, 1.0];
...
function init()
{
	...
	"{" +
		...
		"{" +
			...
			"vec3 light_direction_RED = normalize(vec3(u_light_position_RED) - (eyeCoord).xyz);" +
			"vec3 light_direction_GREEN = normalize(vec3(u_light_position_GREEN) - (eyeCoord).xyz);" +
			"vec3 light_direction_BLUE = normalize(vec3(u_light_position_BLUE) - (eyeCoord).xyz);" +

			"float tn_dot_ldirection_RED = max(dot(tnorm, light_direction_RED), 0.0);" +
			"float tn_dot_ldirection_GREEN = max(dot(tnorm, light_direction_GREEN), 0.0);" +
			"float tn_dot_ldirection_BLUE = max(dot(tnorm, light_direction_BLUE), 0.0);" +
			...
			"vec3 light_RED = ambient_RED + difuse_RED + specular_RED;" +
			"vec3 light_GREEN = ambient_GREEN + difuse_GREEN + specular_GREEN;" +
			"vec3 light_BLUE = ambient_BLUE + difuse_BLUE + specular_BLUE;" +

			"ads_light = light_RED + light_GREEN + light_BLUE;" +
		"}" +
		"else" +
		"{" +
	...
	laUniform_PV_RED	= gl.getUniformLocation(shaderProgramObject_PV, "u_la_RED");
	laUniform_PV_GREEN	= gl.getUniformLocation(shaderProgramObject_PV, "u_la_GREEN");
	laUniform_PV_BLUE	= gl.getUniformLocation(shaderProgramObject_PV, "u_la_BLUE");

	ldUniform_PV_RED = gl.getUniformLocation(shaderProgramObject_PV, "u_ld_RED");
	ldUniform_PV_GREEN = gl.getUniformLocation(shaderProgramObject_PV, "u_ld_GREEN");
	ldUniform_PV_BLUE = gl.getUniformLocation(shaderProgramObject_PV, "u_ld_BLUE");

	lsUniform_PV_RED = gl.getUniformLocation(shaderProgramObject_PV, "u_ls_RED");
	lsUniform_PV_GREEN = gl.getUniformLocation(shaderProgramObject_PV, "u_ls_GREEN");
	lsUniform_PV_BLUE = gl.getUniformLocation(shaderProgramObject_PV, "u_ls_BLUE");
	...
	lightPositionUniform_PV_RED = gl.getUniformLocation(shaderProgramObject_PV, "u_light_position_RED");
	lightPositionUniform_PV_GREEN = gl.getUniformLocation(shaderProgramObject_PV, "u_light_position_GREEN");
	lightPositionUniform_PV_BLUE = gl.getUniformLocation(shaderProgramObject_PV, "u_light_position_BLUE");
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	///////////////////////Per Fragment ///////////////////////
	//vertexShader code
...
function draw()
{
	...
	// {
		...
		if(bLkeyPressed == 1)
		{
			...
			gl.uniform3fv(laUniform_PV_RED, lightAmbient);
			gl.uniform3fv(laUniform_PV_GREEN, lightAmbient);
			gl.uniform3fv(laUniform_PV_BLUE, lightAmbient);

			gl.uniform3fv(ldUniform_PV_RED, lightDifuse_RED);
			gl.uniform3fv(ldUniform_PV_GREEN, lightDifuse_GREEN);
			gl.uniform3fv(ldUniform_PV_BLUE, lightDifuse_BLUE);

			gl.uniform3fv(lsUniform_PV_RED, lightSpecular_RED);
			gl.uniform3fv(lsUniform_PV_GREEN, lightSpecular_GREEN);
			gl.uniform3fv(lsUniform_PV_BLUE, lightSpecular_BLUE);
			...
			gl.uniform4fv(lightPositionUniform_PV_RED, lightPosition_RED);
			gl.uniform4fv(lightPositionUniform_PV_GREEN, lightPosition_GREEN);
			gl.uniform4fv(lightPositionUniform_PV_BLUE, lightPosition_BLUE);
		}
		else
		{
	...
	lightPosition_RED = [ 100.0, degToRad(angle_light), degToRad(angle_light), 1.0];
	lightPosition_GREEN = [ degToRad(angle_light), 100.0, degToRad(angle_light), 1.0];
	lightPosition_BLUE = [ degToRad(angle_light), degToRad(angle_light), 100.0, 1.0];
}
