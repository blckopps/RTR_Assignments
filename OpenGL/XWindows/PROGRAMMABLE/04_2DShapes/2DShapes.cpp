...
void CreateWindow(void)
{
	...
	int iNumberOfFBConfigs = 0;
        ...
        gWindow = XCreateWindow(gpdisplay,
         ...
         XStoreName(gpdisplay, gWindow, "2D Shapes");
...
void Uninitialize(void)
{
	...
	if(vbo_postion_triangle)
	{
		glDeleteBuffers(1,&vbo_postion_triangle);
		vbo_postion_triangle = 0;
	}
	if (vao_rectangle)
	{
...
void initialize(void)
{
	...
	glGenBuffers(1, &vbo_postion_triangle);

	glBindBuffer(GL_ARRAY_BUFFER,
				 vbo_postion_triangle);
