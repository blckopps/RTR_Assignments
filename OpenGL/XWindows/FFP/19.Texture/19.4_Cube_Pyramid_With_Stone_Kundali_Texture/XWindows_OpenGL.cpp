...
GLuint stonetexture,kundalitexture;
...
void CreateWindow(void)
{
	fprintf(gpfile,"CreateWindow Start");
        ...
        gWindow = XCreateWindow(gpdisplay,
         ...
         XStoreName(gpdisplay, gWindow, "Stone_Kundali_Pyramid_Cube");
...
void initialize(void)
{
	...
	LoadTexture(&stonetexture,"Stone.bmp");
	LoadTexture(&kundalitexture,"Kundali.bmp");
	//	
...
void display()
{
	...
	//////////////CUBE//////////////
	glLoadIdentity();
	glTranslatef(2.2f, 0.0f, -6.0f);
	//glRotatef(180.0f, 0.0f, 0.0f, 1.0f);
	glRotatef(angle, 0.0f, 1.0f, 0.0f);
	glBindTexture(GL_TEXTURE_2D, kundalitexture);
	glBegin(GL_QUADS);
	//top
	glTexCoord2f(0.0f, 1.0f);		//RED
	...
	//Right
	glTexCoord2f(1.0f, 0.0f);		//magneta
	glVertex3f(1.0f, 1.0f, -1.0f);					//RT
