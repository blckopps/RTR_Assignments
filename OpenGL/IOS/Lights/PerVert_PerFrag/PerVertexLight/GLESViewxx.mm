...
-(id) initWithFrame:(CGRect)frame
{
    ...
    if (self )
    {
        ...
        [mySphere getSphereVertexDataWithPosition:sphere_vertices withNormals:shpere_normals withTexCoords:sphere_textures andElements:shpere_elements];
...
-(void)drawView:(id)sender
{
    ...
    if(gbLight == YES)
    {
        ...
        printf("in gbLight YES value of Uniform is %d",gLKeyPressedUniform);
        
    }
    else
    {
        glUniform1i(gLKeyPressedUniform,0);
        printf("in gbLight NO value of Uniform is %d",gLKeyPressedUniform);
    }
