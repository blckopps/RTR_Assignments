...
@implementation GLESView
{
    ...
    GLuint iVertexArrayObject;
    GLuint iVertexBufferObject;
    GLuint Uniform_MVP;
    
    
    vmath::mat4 orthographicProjrctionMatrix;
...
-(id) initWithFrame:(CGRect)frame
{
    ...
    if (self )
    {
        ...
        glGenBuffers( 1, &iVertexArrayObject );
        glBindVertexArray( iVertexArrayObject );
        ...
        orthographicProjrctionMatrix = vmath::mat4::identity();
...
-(void)drawView:(id)sender
{
    ...
    vmath::mat4 modelViewProjectionMatrix = orthographicProjrctionMatrix * modelViewMatrix;
...
-(void)layoutSubviews
{
    ...
    if(width <= height)
        orthographicProjrctionMatrix = vmath::ortho(-100.0f, 100.0f, (-100.0f*(fHeight/fWidth)), (100.0f*(fHeight/fWidth)), -100.0f, 100.0f);
    else
        orthographicProjrctionMatrix = vmath::ortho((-100.0f*(fWidth/fHeight)), (100.0f*(fWidth/fHeight)), -100.0f, 100.0f, -100.0f, 100.0f);
